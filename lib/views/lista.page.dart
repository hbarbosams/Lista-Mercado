...
class _ListaPageState extends State<ListaPage> {
  ...
  Future updateItem(BuildContext context, List<Item> item) async {
    var result =
        await Navigator.of(context).pushNamed('/atualizar', arguments: item);
    if (result == true) {
      setState(() {
        this.itens = repository.read();
      });
            ...
            return Dismissible(
              ...
              onDismissed: (direction) {
                if (direction == DismissDirection.startToEnd) {
                  ...
                  Navigator.of(context)
                      .pushNamed('/atualizar', arguments: item);
                }
              },
              ...
              child: CheckboxListTile(
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            decoration: item.comprado
                                ...
                                : TextDecoration.none,
                            color: item.comprado ? Colors.red : Colors.black),
                      ),
                  ...
                  secondary: CircleAvatar(
                    ...
                    backgroundColor: item.comprado ? Colors.red : Colors.green,
                  ),
                  value: item.comprado,
                  onChanged: (value) {
                    setState(() {
                  ...
                  activeColor: item.comprado ? Colors.red : Colors.green),
            );
          },
        ),
